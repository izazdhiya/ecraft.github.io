        ...
        <div class="carousel-inner">
                ...
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="<?= BASEURL; ?>/img/lampuGantung.png" alt="">
                        </div>
            ...
            <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="<?= BASEURL; ?>/img/Gelang dari Kerang.png" alt="">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left">
            ...
            <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="<?= BASEURL; ?>/img/tempat tisu lebah.png" alt="">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left">
    ...
    <section class="container py-5">
        <div class="row text-center pt-3">
            <div class="col-lg-6 m-auto">
                <h1 class="h1">Kategori Terpopuler Bulan Ini</h1>
                <p>
                    Kategori yang sering diminati oleh pembeli dan paling populer dalam bulan ini.
                </p>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="<?= BASEURL; ?>/shop/<?= $category[$x]["id"]; ?>"><img src="<?= BASEURL; ?>/img/<?=$category[$x]["picture"]?>" class="rounded-circle img-fluid border"></a>
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="<?= BASEURL; ?>/shop/detail/<?= $product[$x]["id"]; ?>">
                            <img src="<?= BASEURL; ?>/img/<?=$product[$x]["picture"]?>" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
